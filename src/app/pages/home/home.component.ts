...
import {
  ValueHelpComponent,
  ValueHelpDynamicFormControl,
} from 'src/app/components/value-help/value-help/value-help.component';
...
export class HomeComponent {
  ...
  constructor(private readonly formGeneratorService: FormGeneratorService) {
    this.formGeneratorService.addComponent(ValueHelpComponent, ['value-help']);
  }

  questions: DynamicFormItem<{}, ValueHelpDynamicFormControl>[] = [
    {
      type: 'value-help',
      name: 'fornecedor',
      message: 'Fornecedor',
      required: true,
      guiOptions: {
        hint: 'Informe o codigo do fornecedor.',
      },
    },
    {
      name: 'some',
    ...
    },
    {
      ...
      validators: [Validators.required],
      validate: (input: any) =>
        input?.length > 0 ? null : 'You need to select some country',
    },
    {
      type: 'list',
      name: 'department',
    ...
    },
    {
      ...
      validate: (result: string) =>
        result === 'Angular' ? null : 'You should pick Angular',
    },
    {
      type: 'datepicker',
      name: 'birthday',
      ...
      validate: (value: FdDate) =>
        value !== null && value.year < 2020
          ? null
          : 'You need to be born before 2020',
